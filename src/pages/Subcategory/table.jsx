...
const DatatableTables = () => {
    ...
    const handleDelete = (realId) => {
        ...
        if (window.confirm("Are you sure you want to delete this category?")) {
            axios.delete(`https://backend.outlinekerala.com/admin_app/api/subcategories/${realId}/`)
                .then(() => fetchData())
    ...
    const handleFormSubmit = (e) => {
        ...
        const url = editId
            ? `https://backend.outlinekerala.com/admin_app/api/subcategories/${editId}/`
    ...
    document.title = "Sub Category | Outline Kerala";

    return (
        <div className="page-content">
            <div className="container-fluid">
                <Breadcrumbs title="Tables" breadcrumbItem="Sub Category List" />
                <TableContainer
                    columns={columns}
